...
# ---- Hostname ----
HOSTNAME_FQDN="master-02.pvq.lab"
...
cp /root/k8s/cluster-certs/*.crt /root/k8s/cluster-certs/*.key /root/k8s/cluster-certs/*.pub /etc/kubernetes/pki/
cp /root/k8s/cluster-certs/etcd/ca.* /etc/kubernetes/pki/etcd/
mv /root/k8s/cluster-certs/master-join-cmd /root/k8s/cluster-certs/master-join-cmd.sh
chmod +x /root/k8s/cluster-certs/master-join-cmd.sh
/root/k8s/cluster-certs/master-join-cmd.sh
